...
public class ProcessingTopology {
	public static void main(String[] args) throws Exception {
		...
		builder.setBolt("bolt_join1", new TestBolt(), paralellism).shuffleGrouping("bolt_filter");
		builder.setBolt("bolt_join2", new TestBolt(), paralellism).shuffleGrouping("bolt_filter");
		...
		builder.setBolt("bolt_normalized", new TransformBolt(), paralellism).shuffleGrouping("bolt_join2");
		builder.setBolt("bolt_output1", new TestBolt(),paralellism).shuffleGrouping("bolt_join1");
		builder.setBolt("bolt_output2", new TestBolt(),paralellism).shuffleGrouping("bolt_normalized");
